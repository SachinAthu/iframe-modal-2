    ...
    class Modal {
        ...
        */
        private function generateStyles() {
            ...
            .payment-gateway-modal .content .body embed,
            .payment-gateway-modal .content .body object {
                width: 100%;
                height: 100%;
                border: none;
            }
        ...
        */
        private function generateModal() {
            // https://merchant-api-live-v2.onepay.lk
            // https://gateway-v2-dev.onepay.lk
            // https://www.sampathvishwa.com/

            $iframe = "
            <iframe 
                src={$this->res_data->gateway->redirect_url}
                title='Onepay Payment Gateway'
                allow=\"https://merchant-api-live-v2.onepay.lk\"
            ...
            <object
                type='text/html'
                data={$this->res_data->gateway->redirect_url}
                title='Onepay Payment Gateway'
            ></object>   
            ";
